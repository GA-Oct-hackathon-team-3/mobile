...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/_layout` | `/_layout` | `/(auth)/landing` | `/landing` | `/(auth)/login` | `/login` | `/(auth)/signup` | `/signup` | `/(tabs)/_layout` | `/(tabs)/calendar` | `/calendar` | `/(tabs)/gifts` | `/gifts` | `/(tabs)/` | `/(tabs)` | `/(tabs)/profile` | `/profile` | `/(tabs)/reminders` | `/reminders` | `/+html` | `/add-friend` | `/add-tags` | `/filters` | `/settings`;
  // prettier-ignore
