...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/_layout` | `/_layout` | `/(auth)/landing` | `/landing` | `/(auth)/login` | `/login` | `/(auth)/signup` | `/signup` | `/(tabs)/_layout` | `/(tabs)/calendar` | `/calendar` | `/(tabs)/gifts` | `/gifts` | `/(tabs)/` | `/(tabs)` | `/(tabs)/profile` | `/profile` | `/(tabs)/reminders` | `/reminders` | `/+html` | `/add-friend` | `/filters` | `/settings`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/${CatchAllRoutePart<T>}` | `/users/${SingleRoutePart<T>}/add-tags` | `/users/${SingleRoutePart<T>}/edit-tags` | `/users/${SingleRoutePart<T>}/` | `/users/${SingleRoutePart<T>}/update`;
  // prettier-ignore
  type DynamicRouteTemplate = `/[...missing]` | `/users/[id]/add-tags` | `/users/[id]/edit-tags` | `/users/[id]/` | `/users/[id]/update`;
